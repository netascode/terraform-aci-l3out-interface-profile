...
| <a name="input_transport_data_plane"></a> [transport\_data\_plane](#input\_transport\_data\_plane) | Transport Data Plane. Allowed values: sr\_mpls, mpls | `string` | `"sr_mpls"` | no |
